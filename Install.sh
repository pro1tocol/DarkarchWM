...
pacstrap /mnt alsa-utils pipewire-pulse brightnessctl xterm kitty dolphin gwenview mpv && \
pacstrap /mnt fastfetch polybar kde-gtk-config qt5ct qt6ct breeze breeze-icons flatpak && \
pacstrap /mnt picom screenkey slop libappindicator-gtk3 lxdm i3-wm i3blocks rofi ranger w3m && \
